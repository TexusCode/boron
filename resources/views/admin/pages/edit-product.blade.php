            ...
            <div class="grid grid-cols-1 lg:gap-6 lg:grid-cols-5">
                ...
                <div class="col-span-full">
                    ...
                    <textarea id="description" name="description" rows="20"
                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 min-h-[320px]">{{ old('description', $product->description) }}</textarea>
                </div>

                <!-- Code -->
                <div>
                    <label for="code" class="block text-sm font-medium text-gray-700">Код товара</label>
                    <input type="text" value="{{ $product->code }}" id="code" name="code"
                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                        required>
                ...
                <div>
                    ...
                    <input type="number" value="{{ $product->stock }}" id="stock" name="stock"
                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                        required>
                ...
                <!-- Discount -->
                <div>
                    <label for="discount" class="block text-sm font-medium text-gray-700">Цена со скидкой <span
                            class="text-xs text-red-500">(не обязательно)</span></label>
                ...
                <div>
                    ...
                    <input type="number" value="{{ $product->delivery }}" id="delivery" name="delivery"
                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                        required>
                ...
                <div>
                    ...
                    <input type="file" accept="image/*" id="miniature" name="miniature"
                        class="block w-full mt-1 text-gray-500">
                </div>
                <div>
                    <label for="otherphotos" class="block text-sm font-medium text-gray-700">Дополнительные изображения
                        продукта</label>
                    <input type="file" accept="image/*" multiple id="otherphotos" name="otherphotos[]"
                        class="block w-full mt-1 text-gray-500">
                </div>
                ...
                <div class="flex justify-start col-span-full">
                    <button type="submit"
                        class="px-4 py-2 font-semibold text-white bg-blue-600 rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        Обновить продукт
                    </button>
                </div>
            </div>
