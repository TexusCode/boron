        ...
        <div class="flex flex-wrap items-center gap-6">
            ...
            <div class="flex-1">
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <span class="inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold ring-1 {{ $verifiedBadge }}">
                ...
                <p class="text-sm text-gray-500">Телефон: <a href="tel:{{ $seller->store_phone }}" class="font-semibold text-indigo-600">+992 {{ $seller->store_phone }}</a></p>
            </div>
        ...
        <div class="space-y-6">
            <div class="rounded-3xl bg-white p-6 shadow-sm">
                ...
                <div class="mt-4 space-y-3 text-sm">
                    <a href="mailto:{{ $seller->user->email ?? '' }}" class="flex items-center justify-between rounded-2xl border border-gray-100 p-4 hover:bg-gray-50">
                        <span>Написать письмо</span>
                        <span class="text-xs text-gray-400">Email</span>
                    </a>
                    <a href="tel:{{ $seller->store_phone }}" class="flex items-center justify-between rounded-2xl border border-gray-100 p-4 hover:bg-gray-50">
                        <span>Позвонить</span>
    ...
    <div class="rounded-3xl bg-white p-6 shadow-sm">
        ...
        <div class="mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            @forelse ($products as $product)
                @include('admin.partials.product-card', ['product' => $product, 'showSelection' => false])
            @empty
