<li>
    @if($togle)
    <a href="{{ route('moysklad-settings') }}" class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        ...
        <span class="flex-1 ml-3 whitespace-nowrap">Настройки МойСклад</span>
    </a>
    @endif
</li>
