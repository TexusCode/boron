...
<div class="">
    ...
    <form action="{{ route('add-product-post-selle') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="grid grid-cols-1 lg:gap-6 lg:grid-cols-5">
            ...
            <div class="col-span-full">
                ...
                <textarea id="description" name="description" rows="20" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 min-h-[320px]">{{ old('description') }}</textarea>
            </div>
