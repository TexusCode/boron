    ...
    @if ($courier)
        ...
        <div class="grid gap-4">
            @forelse ($orders as $order)
                <article class="group relative overflow-hidden rounded-[2rem] border border-slate-100 bg-white/90 p-6 shadow-lg shadow-emerald-100 ring-1 ring-white/60">
                    <div class="pointer-events-none absolute -right-10 -top-10 h-40 w-40 rounded-full bg-emerald-200/30 blur-3xl"></div>
                    <div class="pointer-events-none absolute -left-12 bottom-0 h-36 w-36 rounded-full bg-sky-200/30 blur-3xl"></div>
                    ...
                    <div class="mt-5 grid gap-3 text-sm text-slate-600 sm:grid-cols-2">
                        <div class="rounded-2xl border border-slate-100 bg-gradient-to-br from-white to-emerald-50/60 p-4 shadow-sm">
                        ...
                        <div class="rounded-2xl border border-slate-100 bg-gradient-to-br from-white to-sky-50/60 p-4 shadow-sm">
                    ...
                    <div id="order-{{ $order->id }}" class="mt-4 hidden rounded-2xl border border-rose-100 bg-rose-50/70 p-4">
