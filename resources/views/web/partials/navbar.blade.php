        ...
        <div class="max-w-screen-xl px-2 mx-auto 2xl:px-0">
            <div class="flex flex-wrap items-center justify-between gap-x-16 gap-y-4 md:gap-x-8 lg:flex-nowrap">
                <div class="flex shrink-0 md:order-1 lg:gap-10">
                    ...
                    <button class="hidden px-3 py-1 text-lg font-bold uppercase duration-150 bg-white rounded-lg text-primary-700 hover:text-white hover:bg-primary-700 hover:ring-2 hover:ring-white lg:flex lg:gap-2 lg:items-center" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-large-modal" data-hs-overlay="#hs-large-modal">
                ...
                <div class="flex items-center justify-end md:order-3 lg:space-x-2">
                    <a href="{{ route('shopcart') }}" class="items-center justify-center hidden p-2 text-sm font-medium leading-none text-white duration-150 rounded-lg lg:inline-flex hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-primary-700 dark:text-white">
                    ...
                    <div class="hidden lg:block">
                        @guest
                        <a href="{{ route('login') }}" class="inline-flex items-center justify-center p-2 text-sm font-medium leading-none text-white duration-150 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-primary-700 dark:text-white">
                        ...
                        <button id="accountDropdownButton5" data-dropdown-toggle="accountDropdown5" type="button" class="inline-flex items-center justify-center p-2 text-sm font-medium leading-none text-white duration-150 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-primary-700 dark:text-white">
                        ...
                        <!-- Dropdown Menu -->
                        <div id="accountDropdown5" class="z-50 hidden overflow-hidden overflow-y-auto antialiased bg-white divide-y divide-gray-100 rounded-lg shadow w-60 dark:divide-gray-600 dark:bg-gray-700">
                            <div class="space-y-0">
                    ...
                    <div class="relative md:hidden">
                        <button type="button" data-collapse-toggle="ecommerce-navbar-menu-5" class="inline-flex items-center justify-center p-2 text-sm font-medium leading-none text-white rounded-lg hover:text-primary-700 hover:bg-gray-100 dark:hover:bg-gray-700">
                            <span class="sr-only">
                                Menu
                            </span>
                ...
                <form class="w-full md:w-auto md:flex-1 md:order-2" action="{{ route('search') }}">
                    ...
                    <div class="relative">
                        ...
                        <input name="search" value="{{ request('search') }}" type="search" id="default-search" class="block w-full h-full px-4 text-sm text-gray-900 border border-gray-300 rounded-lg ps-10 bg-gray-50 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Что ишете..." />

                        <button type="submit" class="absolute px-4 py-1 text-sm font-medium text-white rounded-md end-1 bottom-1 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Искать</button>
                    </div>
                </form>

                <div id="ecommerce-navbar-menu-5" class="hidden w-full px-4 py-3 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                    <ul class="space-y-3 text-sm font-medium text-gray-900 dark:text-white">
                        <li>
                            <a href="{{ route('home') }}" class="hover:text-primary-700 dark:hover:text-primary-500">Главная</a>
                        </li>
                        <li>
                            <a href="{{ route('filters') }}" class="hover:text-primary-700 dark:hover:text-primary-500">Все товары</a>
                        </li>
                        <li>
                            <a href="{{ route('discounted-products') }}" class="hover:text-primary-700 dark:hover:text-primary-500">Товары со скидкой</a>
                        </li>
                        <li>
                            <a href="{{ route('all-sellers') }}" class="hover:text-primary-700 dark:hover:text-primary-500">Все продавцы</a>
                        </li>
                        <li>
                            <a href="{{ route('become-a-seller') }}" class="hover:text-primary-700 dark:hover:text-primary-500">Стать продавцом</a>
                        </li>
        ...
        <div class="flex items-center justify-between max-w-screen-xl px-2 mx-auto 2xl:px-0">
            <ul class="flex items-center gap-8">
                <li class="hidden sm:flex">
                    <a href="{{ route('filters') }}" title="" class="inline-flex items-center gap-1 text-sm font-medium text-gray-900 hover:text-primary-700 dark:text-white dark:hover:text-primary-500">

                        Все товары
                    </a>
                </li>
                <li class="hidden sm:flex">
                    <a href="{{ route('discounted-products') }}" class="inline-flex items-center gap-1 text-sm font-medium text-gray-900 hover:text-primary-700 dark:text-white dark:hover:text-primary-500">
                        Товары со скидкой
                    </a>
                </li>
                <li class="hidden sm:flex">
                    <a href="{{ route('all-sellers') }}" class="inline-flex items-center gap-1 text-sm font-medium text-gray-900 hover:text-primary-700 dark:text-white dark:hover:text-primary-500">
                ...
                <li class="hidden md:flex">
                    <a href="{{ route('become-a-seller') }}" class="items-center hidden gap-1 text-sm font-medium text-gray-900 lg:inline-flex hover:text-primary-700 dark:text-white dark:hover:text-primary-500">
                        Стать продавцом
                    </a>
                </li>
            </ul>
