        ...
        <section class="antialiased dark:bg-gray-900">
            <div class="max-w-screen-xl px-2 mx-auto mt-2 2xl:px-0">
                <div class="items-end justify-between pb-2 space-y-4 sm:flex sm:space-y-0">
                    <div>
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Рекомендуемые товары
                        </h2>
                    </div>
                </div>
                ...
                <div id="home-loading" class="flex justify-center w-full hidden">
                    <span class="px-4 py-2 text-sm text-gray-500">Загрузка...</span>
                </div>
